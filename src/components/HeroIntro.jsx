...
const HeroIntro = () => {
      return (
            <div className='gap bg-gray-100'>
                  <div className="container mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 px-3 md:px-8">
                        <HeroIntroChild title="our history" pointDes={[]} description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente, provident accusantium. Voluptatem ut perspiciatis a quas nisi reiciendis similique distinctio!" Icon={RiHistoryLine} />
