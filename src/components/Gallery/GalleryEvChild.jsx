...
const GalleryEvChild = () => {
      return (
            <div className='grid grid-cols-10 gap-2'>
                  <div className='bg-[#0A5174] text-white p-2 sm:p-4 rounded-tl-md rounded-bl-md w-fit col-span-2 flex items-center justify-center'>
                        <div className='flex flex-col gap-1 text-center'>
                              <h1 className='font-medium text-2xl sm:text-4xl'>28</h1>
                              <div className='w-full h-[1px] bg-white'></div>
                              <p className='text-lg sm:text-xl font-normal uppercase'>Feb</p>
                        </div>
                  </div>
                  <div className='col-span-8 flex flex-col gap-3 md:pr-4'>
                        <h1 className='font-semibold text-base sm:text-lg text-gray-700'>Gallery event child</h1>
